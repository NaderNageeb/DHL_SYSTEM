...
<section class="section">
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Collected Shipping Requests
          </h5>
...
<?php
     ...
     echo '<span class="badge bg-brimary">Collected</span>';
?>
...
<?php
           ...
           echo '<span class="badge bg-brimary">Arrived</span>';
?>
      <a href="Shipping_requests_detils.php?request_id=<?php echo $rows['request_id'];?>" target="_blank" class="badge bg-warning">Detils</a>
<?php
